  ...
  return (
    <div className='relative w-full md:max-h-[95vh] overflow-y-auto  bg-white p-4 rounded-md transition-all duration-300 ease-in-out'>
      <div className="flex justify-between items-center">
        ...
        <button className="rounded-md bg-white p-2 border text-center font-bold text-sm text-slate-800 transition-all shadow-md hover:shadow-lg focus:bg-slate-700 focus:shadow-none active:bg-slate-700 hover:bg-slate-700 hover:text-white active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" onClick={() => setIsCsvVisible(false)}> Retour au formulaire</button>
      </div>
