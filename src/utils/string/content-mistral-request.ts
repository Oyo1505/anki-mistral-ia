...
export const contentMistralRequest = ({ typeCard, japanese, numberOfCards,level, kanji, romanji}: ContentMistralRequestParams) => {
  return typeCard === 'basique' ? `-> Tu es fais pour faire des carte anki basique de japonais.
